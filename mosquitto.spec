...
Source0  : https://mosquitto.org/files/source/mosquitto-1.6.11.tar.gz
Source1  : https://mosquitto.org/files/source/mosquitto-1.6.11.tar.gz.asc
...
%prep
%setup -q -n mosquitto-1.6.11
cd %{_builddir}/mosquitto-1.6.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597163677
...
cp %{_builddir}/mosquitto-1.6.11/LICENSE.txt %{buildroot}/usr/share/package-licenses/mosquitto/c29262248058be3ddc0c84a632afcb317275d738
