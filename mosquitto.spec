...
Source0  : https://mosquitto.org/files/source/mosquitto-2.0.21.tar.gz
Source1  : https://mosquitto.org/files/source/mosquitto-2.0.21.tar.gz.asc
...
%setup -q -n mosquitto-2.0.21
cd %{_builddir}/mosquitto-2.0.21
pushd ..
cp -a mosquitto-2.0.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742442461
