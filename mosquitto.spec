...
Source0  : https://mosquitto.org/files/source/mosquitto-2.0.20.tar.gz
Source1  : https://mosquitto.org/files/source/mosquitto-2.0.20.tar.gz.asc
...
%setup -q -n mosquitto-2.0.20
cd %{_builddir}/mosquitto-2.0.20
pushd ..
cp -a mosquitto-2.0.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729119953
