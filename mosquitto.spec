...
Source0  : https://mosquitto.org/files/source/mosquitto-2.0.22.tar.gz
Source1  : https://mosquitto.org/files/source/mosquitto-2.0.22.tar.gz.asc
Source2  : 779B22DFB3E717B7.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) 779B22DFB3E717B7' gpg.status
%setup -q -n mosquitto-2.0.22
cd %{_builddir}/mosquitto-2.0.22
pushd ..
cp -a mosquitto-2.0.22 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752502955
...
cp %{_builddir}/mosquitto-%{version}/epl-v20 %{buildroot}/usr/share/package-licenses/mosquitto/cc1b9f6357720c4005d01f48196e732e6f2415ad || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
...
/usr/share/package-licenses/mosquitto/cc1b9f6357720c4005d01f48196e732e6f2415ad
