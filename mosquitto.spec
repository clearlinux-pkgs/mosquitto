...
Source0  : http://mosquitto.org/files/source/mosquitto-1.6.3.tar.gz
Source99 : http://mosquitto.org/files/source/mosquitto-1.6.3.tar.gz.asc
...
export LANG=C
export SOURCE_DATE_EPOCH=1561138550
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libmosquitto.so.1.6.3
/usr/lib64/libmosquittopp.so.1
/usr/lib64/libmosquittopp.so.1.6.3
